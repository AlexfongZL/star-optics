    ...
    <input type="hidden" name="supp_id" value="<?php echo $supp['supp_id']; ?>">
      <table> 
        ...
        <tr height="50">
          ...
          <td><textarea type="text" style="width: 300px; height: 60px;" size="47" rows="3" cols="50" name="supp_addr" id="supp_addr" onblur="this.value=this.value.toUpperCase();" onkeyup="this.value=this.value.toUpperCase();"/><?php echo $supp['address']; ?></textarea></td>
        </tr>
        ...
        <tr>
          <td>Remarks:</td>
          <td><textarea type="text" style="width: 300px; height: 85px;" size="47" rows="3" cols="50" name="supp_remarks" id="supp_remarks"/><?php echo $supp['remarks']; ?></textarea></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="submit" class="save-btn" name="edit_supplier_submit" value="Save" width="93" height="25"/></td>
        </tr>
      </table>
    </form>
  </fieldset>
