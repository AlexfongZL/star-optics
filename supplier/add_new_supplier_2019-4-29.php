   ...
   <form action="action.php" method="post">
      ...
      <h3>Enters the supplier information below</h3> 
        ...
        <tr height="50">
          ...
          <td><textarea type="text" size="47" rows="3" cols="50" name="supp_addr" id="supp_addr" onblur="this.value=this.value.toUpperCase();" onkeyup="this.value=this.value.toUpperCase();" autocomplete="off"/></textarea></td>
        </tr>
        ...
        <tr>
          <td>Remarks:</td>
          <td><textarea type="text" size="47" name="supp_remarks" id="supp_remarks" autocomplete="off"/></textarea></td>
        </tr>

        <tr>
          <td><input type="submit" name="add_supplier_submit" value="Add Supplier"></td>
