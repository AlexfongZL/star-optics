    ...
    <div class="column" style="border-right: 5px solid red;">
      <h3>Edit item information below</h3>
        <form action="action.php" method="post">
          ...
          Type: <select id="item_type" name="item_type" disabled="disabled">
          ...
          <input type="checkbox" name="checkbox[]" value="singled" id="check_single" <?php if($item["quantity_type"] == 'SINGLED'){echo 'checked="checked"';} ?> disabled="disabled"/>Singled Item
          
          <input type="checkbox" name="checkbox[]" value="boxed" id="check_boxed" <?php if($item["quantity_type"] == 'BOXED'){echo 'checked="checked"';} ?> disabled="disabled"/>Boxed Item<br>
            <br/>
          ...
          <div id="check_boxed_div">
            Number of Boxes:<input value="<?php echo $item["num_of_box"]; ?>" type="number" name="item_box_num" id="item_box_num" onblur="this.value=this.value.toUpperCase();" onkeyup="this.value=this.value.toUpperCase();"disabled="disabled"/><br><br>

            Number per Boxes:<input value="<?php echo $item["num_per_box"]; ?>" type="number" name="item_num_per_box" id="item_num_per_box" onblur="this.value=this.value.toUpperCase();" onkeyup="this.value=this.value.toUpperCase();"disabled="disabled"/><br><br>

            Total Quantity: <input value="<?php echo $item["quantity_box"]; ?>" type="number" name="item_quantity_box" id="item_quantity_box" disabled="disabled"/><br><br>
          </div>

          <div>
            Minimum Quantity:<input value="<?php echo $item["min_quantity"]; ?>" type="number" name="min_quantity" id="min_quantity" onblur="this.value=this.value.toUpperCase();" onkeyup="this.value=this.value.toUpperCase();"disabled="disabled"/><br><br>
          </div>
            <br/>
